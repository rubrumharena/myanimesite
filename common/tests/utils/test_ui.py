...
class CalendarGeneratorTestCase(TestCase):
    def setUp(self):
        self.expected_years_and_decades = [
            '2028',
            '2027',
            '2026',
            '2025',
...
class StarFillingTestCase(unittest.TestCase):
    def test_partial_star_logic_success(self):
        self.assertEqual(
            get_partial_fill(7.5), {1: 100, 2: 100, 3: 100, 4: 100, 5: 100, 6: 100, 7: 100, 8: 50, 9: 0, 10: 0}
        )
        self.assertEqual(
            get_partial_fill(7.0), {1: 100, 2: 100, 3: 100, 4: 100, 5: 100, 6: 100, 7: 100, 8: 0, 9: 0, 10: 0}
        )
