...
from users.views import SettingsView, ProfileView, FollowerListView, \
    FollowingListView, CommunityListView, delete_avatar, HistoryListView, \
    delete_from_history_ajax, toggle_title_completed_ajax, toggle_follow, check_history_ajax, ProfileSettingsView, \
    AccountSettingsView
