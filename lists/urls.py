...
from lists.views import CollectionListView, get_user_folders_ajax, \
    update_folder_titles_ajax, save_folder_ajax, FolderListView, get_collections_ajax, FolderDeleteView, \
